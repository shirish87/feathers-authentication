...
var _verifyToken = function _verifyToken() {
  ...
  return function (hook) {
    return new Promise(function (resolve, reject) {
      ...
      var verify = options.token && options.token.jwt && options.token.jwt.verify || _jsonwebtoken2.default.verify;
  ...
  _createClass(Service, [{
    ...
    value: function get(id, params) {
      ...
      return new Promise(function (resolve) {
        var sign = options.token && options.token.jwt && options.token.jwt.sign || _jsonwebtoken2.default.sign;
        sign(data, options.secret, options, function (token) {
